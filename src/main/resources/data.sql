...
insert into Vendedor(Id_vendedor,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,inicio_vacaciones,fin_vacaciones,oficio) values (3,'Bruno','Gonsalves','35269686F',678495217,'BrunoGonsa','202cb962ac59075b964b07152d234b70',to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),to_date('2022-08-15','yyyy-mm-dd'),to_date('2022-08-31','yyyy-mm-dd'),'v');
...
insert into PersonalAlmacen(Id_perAlmacen,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,inicio_vacaciones,fin_vacaciones,oficio) values (4,'Nuria','Álvarez','59194727O',665424965,'NuriaAlva','202cb962ac59075b964b07152d234b70',to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),to_date('2021-12-20','yyyy-mm-dd'),to_date('2022-01-04','yyyy-mm-dd'),'pa');