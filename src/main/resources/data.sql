...
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (1,'Juan','Fernández','54827144G',647571418,'JuanFer','1234',to_date('06:00','HH:MM'),to_date('18:00','HH:MM'),'t');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (2,'Lorena','Romero','46281747K',642518935,'LoreRome','1234',to_date('07:00','HH:MM'),to_date('20:00','HH:MM'),'t');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (3,'Luis','Torres','56938577Z',639293514,'LuisTor','1234',to_date('08:00','HH:MM'),to_date('22:00','HH:MM'),'t');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (4,'Victoria','Sánchez','42155995M',649183272,'VicSan','202cb962ac59075b964b07152d234b70',to_date('09:00','HH:MM'),to_date('21:00','HH:MM'),'t');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (5,'Alfonso','Gutierrez','28451263B',648182252,'AlfonGuti',1234,to_date('08:00','HH:MM'),to_date('14:00','HH:MM'),'v');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (6,'Julieta','Venegas','14852217C',614178923,'JuliVene',1234,to_date('08:00','HH:MM'),to_date('14:00','HH:MM'),'v');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (7,'Bruno','Alves','35269686F',678495217,'BrunoAlves','202cb962ac59075b964b07152d234b70',to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),'v');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (8,'Ruperta','Santos','35497124H',695839411,'RupeSantos',1234,to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),'v');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (9,'Esteban','Costa','45426393N',645142796,'EsteCosta',1234,to_date('08:00','HH:MM'),to_date('14:00','HH:MM'),'pa');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (10,'Rosa','López','42154484L',695839533,'RosaLopez',1234,to_date('08:00','HH:MM'),to_date('14:00','HH:MM'),'pa');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (11,'Pablo','Duro','33584771P',662415157,'PabloDuro',1234,to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),'pa');
insert into Empleado (Id_empleado,Nombre,Apellido,DNI,Telefono,Usuario,Contraseña,hora_entrada,hora_salida,oficio) values (12,'Nuria','Álvarez','59194727O',665424965,'NuriaAlva','202cb962ac59075b964b07152d234b70',to_date('15:00','HH:MM'),to_date('21:00','HH:MM'),'pa');
