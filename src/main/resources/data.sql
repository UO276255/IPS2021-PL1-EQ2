...
insert into Transportista (id_transp,Nombre,Apellido,DNI,Numero_tel,Usuario,Contraseña,hora_entrada,hora_salida,inicio_vacaciones,fin_vacaciones,oficio) values (2,'Lorena','Romero','46281747K',642518935,'LoreRome','1234',to_date('07:00','HH:MM'),to_date('20:00','HH:MM'),to_date('2022-07-01','yyyy-mm-dd'),to_date('2022-07-16','yyyy-mm-dd'),'t');
...
insert into Transportista (id_transp,Nombre,Apellido,DNI,Numero_tel,Usuario,Contraseña,hora_entrada,hora_salida,inicio_vacaciones,fin_vacaciones,oficio) values (4,'Victoria','Sánchez','42155995M',64918327,'VicSan','1234',to_date('09:00','HH:MM'),to_date('23:59','HH:MM'),to_date('2021-12-20','yyyy-mm-dd'),to_date('2022-01-04','yyyy-mm-dd'),'t');
